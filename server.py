...
print("FLASK_OIDC_PROVIDER_NAME:  "+FLASK_OIDC_PROVIDER_NAME)
print("FLASK_OIDC_CLIENT_ID:  "+FLASK_OIDC_CLIENT_ID)
print("FLASK_OIDC_CLIENT_SECRET:  "+FLASK_OIDC_CLIENT_SECRET)
print("FLASK_OIDC_CONFIG_URL:  "+FLASK_OIDC_CONFIG_URL)
print("FLASK_OIDC_OVERWRITE_REDIRECT_URI:  "+FLASK_OIDC_OVERWRITE_REDIRECT_URI)
print("FLASK_OIDC_REDIRECT_URI:  "+FLASK_OIDC_REDIRECT_URI)
